...
PM_TO_BLIB = lib/Thrift/ProtocolDecorator.pm \
	...
	blib/lib/Thrift.pm \
	lib/Thrift/ServerSocket.pm \
	blib/lib/Thrift/ServerSocket.pm \
	lib/Thrift/Type.pm \
	...
	lib/Thrift/UnixServerSocket.pm \
	blib/lib/Thrift/UnixServerSocket.pm \
	lib/Thrift/SSLSocket.pm \
	blib/lib/Thrift/SSLSocket.pm \
	lib/Thrift/Socket.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: v0.11.0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "v0.11.0"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Apache Thrift is a software framework for scalable cross-language services development.</ABSTRACT>' >> $(DISTNAME).ppd
